...
要创建您的帐户，请注册https://developers.redhat.com/developer-sandbox[Developer Sandbox for Red Hat OpenShift,window='_blank']。从那里，点击红色按钮，上面写着**Get Started in the Sandbox**，如下图所示。
